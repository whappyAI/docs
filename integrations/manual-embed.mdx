...
If you're not using Shopify, you can still integrate Laxi.ai into your website by adding a simple embed script. This allows the chatbot to function on any platform, including **custom websites, static pages, and other ecommerce platforms**.
...
<img src="/images/integrations/share-deploy-tab.png" alt="Navigating to Share & Deploy tab in Laxi.ai" style={{ marginTop: '1rem', maxWidth: '60%', marginLeft: 'auto', marginRight: 'auto' }} />
...
<img src="/images/integrations/embed-code.png" alt="Laxi.ai Embed Code Example" style={{ marginTop: '1rem', maxWidth: '100%' }} />
...
For further customization options, explore the **[Design Customization Guide](../agent/customizations)**.
