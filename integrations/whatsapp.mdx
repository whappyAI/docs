...
Whappy writes a WhatsApp-compliant template in your business language, drawing on your campaign's context. **You review it before anything is sent to Meta** — nothing is submitted until you press Save.

**Configuration:**
- **What should the template say?** *(optional)* — a plain-language brief, for example *"Remind the customer about their appointment tomorrow and ask them to confirm"*. Leave it empty to generate from your campaign's business context alone.
