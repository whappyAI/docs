...
<Steps>
    ...
    <Step title="Select your trigger event">
        ...
        <img src="/images/zapier/setup-lead-closed.png" alt="Select trigger event in Zapier" />
    </Step>
    ...
    <Step title="Test your trigger">
        ...
        <img src="/images/zapier/test-trigger.png" alt="Test trigger and view sample data" />
...
<Steps>
    ...
    <Step title="Configure the lead data">
        ...
        **Optional Fields:**
        ...
        <img src="/images/zapier/configure-action.png" alt="Configure lead data fields in Zapier action" />
    ...
    <Step title="Test and activate">
        ...
        <img src="/images/zapier/test-action.png" alt="Test action and verify lead creation" />
    </Step>
</Steps>

### Lead Data Field Format

The **Lead Data** field accepts JSON format for passing custom information that you can use in your conversations:
...
This custom data will be visible in the lead's profile and can be referenced in your conversation templates.
