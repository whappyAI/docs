...
<img src="/images/analytics/conversations-tab.png" alt="Navigating to Chat History in Laxi.ai" style={{ marginTop: '1rem', maxWidth: '60%', marginLeft: 'auto', marginRight: 'auto' }} />
...
To improve chatbot responses, consider updating **[Data Sources & AI Training](../agent/data-sources)** based on the insights you gather here.  
