...
You do not have to write any of this from scratch. Press **Generate with AI** and Whappy will draft your context from something you already have.

<Tabs>
    <Tab title="From your website">
        Paste your website URL. Whappy reads the site and drafts your business activity, conversation objective and supporting detail from it.
    </Tab>
    <Tab title="From a document">
        Drop in a file you already have — a brochure, a price list, a service description. PDFs, photos, spreadsheets and text files up to 15 MB.

        You can add an instruction to focus the result, for example *"only the prices, ignore the staff list"*.
    </Tab>
</Tabs>

<Note>
    The file itself is not stored. Whappy reads it, keeps only what it learned, and discards the document.
</Note>

Whatever is generated is a **draft you edit**. Read it before launching — it is written from your material, but it is your business the AI assistant will be describing.
