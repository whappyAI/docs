...
<img src="/images/agent-config/design-tab.png" alt="Navigating to Design Settings in Laxi.ai" style={{ marginTop: '1rem', maxWidth: '60%', marginLeft: 'auto', marginRight: 'auto' }} />
